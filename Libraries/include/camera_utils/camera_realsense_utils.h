...
#ifndef FFMPEG_VIDEO_STREAM_ENCODE_CAMERA_REALSENSE_UTILS_H
#define FFMPEG_VIDEO_STREAM_ENCODE_CAMERA_REALSENSE_UTILS_H
...
#endif //FFMPEG_VIDEO_STREAM_ENCODE_CAMERA_REALSENSE_UTILS_H
